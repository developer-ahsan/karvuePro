...
@section('content')
	<section id="header-area" class="inner-header page-section">
                <div class="section-background">
                    ...
                    <div class="content-wrapper">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2>We Vertize - Car Advertising Platform</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <img alt="" src="{{asset('app-assets/images/about-us-background.jpg?format')}}" style="-webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;">
            ...
            <section id="body-content" class="body-content">
                <div class="default-container advertiser">
                    <div class="container">
            ...
            <section id="advetiser-details" class="about-details" style="background: black">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-4">
                                    <div class="main-heading">
                                        <h2>Earn <span>Money</span> While you Drive</h2>
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In mollis augue quis molestie consequat. Proin ut consectetur libero, quis iaculis elit. Etiam nunc sapien, placerat eu libero semper, cursus luctus neque. Aenean
                                        mollis ex et leo tincidunt consequat.</p>
                                </div>
                            </div>
                        </div>
                    </div>
